...
try:
    ...
    if os.path.exists("_tmp_test.xml"):
        os.remove("_tmp_test.xml")# test_scenes.py
from stable_baselines3 import SAC
import time, os, sys
import numpy as np

SCENES = {
    "1": ("scene_stage4.xml",      "Корридор посередине", (-3.5,-1.0), (3.5, 0.5)),
    "2": ("scene_stage3.xml","Тестовый коридор", (-3.5,-4.0), (3.5,-4.0)),
    "3": ("scene_zigzag.xml",    "Лабиринт", (-3.5,-4.0), (3.5,-4.0)),
}
